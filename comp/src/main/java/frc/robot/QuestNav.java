 ...
 * Quest VR headset
 * for robot localization and tracking purposes. It uses NetworkTables to
...
public class QuestNav {
    ...
    /**
     * Subscriber for raw position data from Quest in Unity coordinate system (in
     * getTranslation, Unity's x becomes FRC's -y, and Unity's z becomes FRC's x)
     */
    ...
    /**
     * Processes heartbeat requests from the Quest headset and responds with the
     * same ID.
     ...
     * Connection is determined by checking when the last battery update was
     * received.
     *
    ...
    /**
     * Cleans up Quest navigation subroutine messages after processing on the
     * headset.
    ...
    /**
     * Converts the raw QuestNav yaw to a Rotation2d object. Applies necessary
     * coordinate system
     * transformations.
     *

...
// ProfiledPIDController arm_PID = new ProfiledPIDController(3, 0, 0, new
// TrapezoidProfile.Constraints(24, 12));
...
// public Command stop() {
// Command command = Commands.repeatingSequence(stopElevator(),
// setScoringWheelSpeed(0));
...
// builder.addDoubleProperty("scoringWheelSpeed", () -> scoringWheelSpeed,
// null);

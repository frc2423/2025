...
//  }
  ...
  public static class OperatorConstants
  {
   ...
   public static class Vision {
    ...
    public static final Matrix<N3, N1> kSingleTagStdDevs = VecBuilder.fill(4, 4, 8 * 2);
    public static final Matrix<N3, N1> kMultiTagStdDevs = VecBuilder.fill(0.5, 0.5, 1 * 2);
  }
}
